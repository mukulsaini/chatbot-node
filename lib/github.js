...
var gh = new GitHub();
const tG = function(req, res){
       let url = `https://api.github.com/search/repositories?q=created:%3E${moment().subtract(7, 'days').format("YYYY-MM-DD")}&sort=stars&order=desc&per_page=10`;;
      console.log(url);   
    rp({
        url: url,
        headers: {
       ...
       for(let i = 0; i < json.items.length ; i++){
         ...
         elements.push({
           ...
           "item_url": json.items[i].html_url,
